...
function stateExplain(row,displayState){
  ...
  if(manual&&isManualActive(manual)){
    ...
    if(manual.type==="offline") return "謇句虚縺ｧ繧ｪ繝輔Λ繧､繝ｳ迥ｶ諷九→縺励※險倬鹸荳ｭ";
    if(manual.type==="won") return "謇句虚縺ｧ蜍晏茜蠕後・謌ｻ繧頑凾髢灘ｸｯ繧定ｨ倬鹸荳ｭ";
    if(manual.type==="final_end") return "謇句虚縺ｧFinal Round邨ゆｺ・ｾ後・謌ｻ繧頑凾髢灘ｸｯ繧定ｨ倬鹸荳ｭ";
    if(String(manual.type||"").startsWith("r1_")) return "謇句虚縺ｧR1隧ｦ蜷井ｸｭ縺ｨ縺励※險倬鹸荳ｭ";
    if(String(manual.type||"").startsWith("r2_")) return "謇句虚縺ｧR2莉･髯阪・隧ｦ蜷井ｸｭ縺ｨ縺励※險倬鹸荳ｭ";
    return `謇句虚險倬鹸縲・{et?et.label:manual.type}縲阪ｒ蜆ｪ蜈郁｡ｨ遉ｺ荳ｭ`;
  }
  switch(displayState){
    case "POST_MATCH_WAIT": return "隧ｦ蜷育ｵゆｺ・峩蠕後・蜿肴丐蠕・■譎る俣蟶ｯ縺ｧ縺吶・;
    case "LOBBY": return "隧ｦ蜷育ｵゆｺ・ｾ後・蠕・ｩ滉ｸｭ縺ｨ謗ｨ螳壹よｬ｡縺ｮ隧ｦ蜷磯幕蟋句呵｣懊〒縺吶・;
    case "IN_MATCH": return "R1隧ｦ蜷井ｸｭ縺ｨ謗ｨ螳壹よｬ｡縺ｮ譖ｴ譁ｰ縺ｾ縺ｧ縺ｯ隧ｦ蜷育ｶ咏ｶ壽桶縺・〒縺吶・;
    case "IN_TOURNAMENT_DEEP": return "R2莉･髯阪・隧ｦ蜷井ｸｭ縺ｨ謗ｨ螳壹・inal騾ｲ陦御ｸｭ縺ｮ蜿ｯ閭ｽ諤ｧ繧貞性縺ｿ縺ｾ縺吶・;
    case "RETURNING": return "Final Round邨ゆｺ・ｾ後・謌ｻ繧頑凾髢灘ｸｯ繧呈耳螳壻ｸｭ縲よｬ｡縺ｮ譖ｴ譁ｰ蠕・■縺ｧ縺吶・;
    case "OFFLINE": return "譛霑代・譖ｴ譁ｰ縺後↑縺上∫樟蝨ｨ縺ｯ髱槭い繧ｯ繝・ぅ繝悶→謗ｨ螳壹・;
    case "UNKNOWN": return "諠・ｱ荳崎ｶｳ縺ｮ縺溘ａ迥ｶ諷九ｒ蛻､螳壹〒縺阪∪縺帙ｓ縲・;
    case "NOT_FOUND": return "繝ｪ繝ｼ繝繝ｼ繝懊・繝峨〒騾｣邯壽悴讀懷・縲・AN縺ｾ縺溘・蜷榊燕螟画峩縺ｮ蜿ｯ閭ｽ諤ｧ縺後≠繧翫∪縺吶・;
    case "BANNED": return "繝ｪ繝ｼ繝繝ｼ繝懊・繝峨°繧牙ｮ悟・豸亥､ｱ縲・AN縺ｮ蜿ｯ閭ｽ諤ｧ縺碁ｫ倥＞迥ｶ諷九〒縺吶・;
    case "NAME_CHANGED": return "蛻･蜷咲ｾｩ縺ｮ蛟呵｣懊ｒ讀懷・縲ょ錐蜑榊､画峩縺ｮ蜿ｯ閭ｽ諤ｧ縺後≠繧翫∪縺吶・;
    default: return "";
  }
}
